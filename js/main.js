...
const OWM_APIKey = "91d67614cabbb8b3e8981ab5c7e73282"
    ...
    navigator.geolocation.getCurrentPosition((position) => {
      ...
      fetch(
        ...
        .then((res) => {
          ...
          lastSunrise.textContent = `${hoursFromSunrise} hour${hoursFromSunrise > 1 ? "s" : ""
            } ago`;
          nextSunset.textContent = `in ${hoursFromSunset} hour${hoursFromSunset > 1 ? "s" : ""
            }`;
        });
    });
  } else {
